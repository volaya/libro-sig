...
\begin{center}
\includegraphics[width=.13\mycolumnwidth]{Creacion_capas_vectoriales/Kernel.pdf}
\end{center}
...
Para un conjunto de puntos $V$, una triangulación es una conjunto de triángulos que cumple las siguientes propiedades\cite{Dyn1990IMA}:
