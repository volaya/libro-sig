...
\item \textbf{Cilíndricas}. La superficie desarrollable es un cilindro (Figura \ref{Fig:Proyeccion_conica_cilindrica}). Al proyectar, los meridianos se convierten en líneas paralelas, así como los paralelos, aunque la distancia entre estos últimos no es constante.
