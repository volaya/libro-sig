...
Como apunta \cite{Tomlin1990Prentice}, \emph{software} y \emph{hardware} son dos elementos primordiales del SIG, pero no son sin embargo los únicos. En el contexto actual, otros componentes juegan un papel igual de importante en la ideal global de un SIG.
