...
\begin{figure}[!hbtp]   
	\centering
	\includegraphics[width=0.90\textwidth]{Otros_tecnologia/TiposDispositivosMoviles.png}
...
\begin{figure}[!hbtp]   
	...
	\caption{\small Dos servicios basados en localizacion sobre un teléfono móvil. A la izquierda, Foursquare[\url{http://www.foursquare.com}]. A la derecha, Google Latitude[\url{http://www.google.com/latitude}].}
