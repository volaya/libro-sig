...
\item \textbf{SIG como herramienta para la difusión de información geográfica}. Su capacidad para exponer los datos geográficos a un público más amplio y hacerlo de una forma óptima es una de las virtudes más notables de los SIG, especialmente con las tecnologías actuales y la situación existente hoy en día. Para muchas disciplinas, poder hacer llegar la información geográfica a ciertos destinatarios supone un hecho importante, y es por ello que los SIG resultan herramientas útiles en esos casos.
